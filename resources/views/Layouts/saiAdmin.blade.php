...
<body>
    <section class="flex h-screen overflow-hidden">
        @yield('content')
        {{-- <div class="bg-white xl:w-4/12 lg:w-4/12 w-full p-6">
            <div class="row" style="display: flex; align-items: center; gap: 16px;">
                <h3 class="text-2xl mb-8">IntelliSai</h3>
                <img src="{{ asset('storage/images/imgCloud.svg')}}" width="120px" alt="Logo de la plataforma">
            </div>            
        ...
        {{-- <div class="bg-gray-100 xl:w-9/12 lg:w-8/12 hidden lg:block">
            ...
            <div class="py-2 px-20 h-3/4 overflow-auto">
                <div class="flex mb-12">
                    <img src="{{ asset('storage/images/sai.png') }}" class="self-end rounded-full w-12 mr-4">
                    <div class="flex flex-col">
                        <div class="bg-white p-6 rounded-3xl rounded-bl-none w-96 shadow-sm mb-2">
                            <p class="font-medium mb-1">SaiBot</p>
                ...
                <div class="flex flex-row-reverse mb-12">
                    ...
                    <div class="flex flex-col">
                        <div class="bg-blue-500 text-white p-6 rounded-3xl rounded-br-none w-96 mb-2">
                            <p class="font-medium mb-1">Cliente del chat</p>
            ...
            <div class="flex py-2 px-20 border-t">
                <div class="w-4/5">
